...
from .clip_encoder import CLIPVisionTower, CLIPVisionTowerS2, CLIPToMeVisionTower
...
def build_vision_tower(vision_tower_cfg, **kwargs):
    ...
    if "siglip" in vision_tower:
        ...
        if use_s2:
            print("Vanilla CLIP: True, with s2")
            return CLIPVisionTowerS2(vision_tower, args=vision_tower_cfg, **kwargs)
        elif not hasattr(vision_tower_cfg, "use_tome") or vision_tower_cfg.use_tome == False:
            print("Vanilla CLIP: True")
            return CLIPVisionTower(vision_tower, args=vision_tower_cfg, **kwargs)
        elif vision_tower_cfg.use_tome:
            print("Token Merge: True")
            return CLIPToMeVisionTower(vision_tower, args=vision_tower_cfg, **kwargs)
